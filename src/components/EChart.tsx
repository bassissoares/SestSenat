...
echarts.use([BarChart, HeatmapChart, LineChart, TreemapChart, DataZoomComponent, GridComponent, LegendComponent, TooltipComponent, VisualMapComponent, CanvasRenderer]);
